              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open_multipart('index.php/menu/add_menu');?>

                    <div class="form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" >Nama Menu</label>
                        <div class="col-md-7 col-sm-6 col-xs-12">
                           <input type="text" class="form-control col-md-7 col-xs-12" name="nama" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4 col-sm-6">
                         <input class="form-control col-md-7 col-xs-12" type="number" name="harga" >
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-6">
                         <textarea class="form-control" rows="4" name="desk"></textarea>
                      </div>
                    </div>
